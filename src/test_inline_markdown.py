...
class TestInlineMarkdown(unittest.TestCase):
    def test_bold_single_node(self):
    ...
    def test_bold_multiple_nodes(self):
        node1 = TextNode("This is one **bold** text", TextType.TEXT)
        node2 = TextNode("And this is another **bold** text", TextType.TEXT)
    ...
    def test_bold_no_close_delimiter(self):
        node = TextNode("This is **bold text", TextType.TEXT)
